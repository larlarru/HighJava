...
class Desc implements Comparator<String> {
	...
	// 예) 오름차순일 경우 ==> 앞의 값이 크면 양수, 같으면0, 뒤의 값이 크면 음수를 반환하도록 하면 된다.
	
	// String 객체에는 정렬을 위해서 compareTo()메서드가 구현되어 있는데
	// 이 메서드의 반환값은 오름차순에 맞게 반화되도록 구현되어 있다.
	...
	public int compare(String str1, String str2) {
		// compare(String arg0, String arg1)는 arg0는 앞에 있는 데이터 arg1는 뒤에 있는 데이터다. 순서가
		...
		return str1.compareTo(str2) * - 1; // if문 대신 쓰는거
